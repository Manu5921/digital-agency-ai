...
var playfair = (0, google_1.Playfair_Display)({
    subsets: ['latin'],
    variable: '--font-playfair'
});
var dancing = (0, google_1.Dancing_Script)({
    subsets: ['latin'],
...
function RootLayout(_a) {
    ...
    return (<html lang="fr" className={"scroll-smooth ".concat(inter.variable, " ").concat(playfair.variable, " ").concat(dancing.variable)}>
      <head>
