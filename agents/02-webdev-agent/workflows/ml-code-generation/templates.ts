...
export abstract class BaseTemplateGenerator {
  ...
  protected context: ITemplateContext;

  constructor(projectType: ProjectType, qualityLevel: QualityLevel, context: ITemplateContext) {
    this.projectType = projectType;
    this.qualityLevel = qualityLevel;
    this.context = context;
  }

  abstract generateComponents(): IComponentSpec[];
  abstract generatePages(): IPageSpec[];
  abstract generateAPIs(): IAPISpec[];
  abstract getProjectStructure(): string[];
  abstract getDependencies(): Record<string, string>;
  abstract getConfiguration(): Record<string, any>;

  protected getBaseQualitySpecs() {
    const qualitySpecs = {
      mvp: {
        accessibility: { required: true, level: 'A' as const, features: ['keyboard', 'semantics'] },
        performance: { lazy: false, memoization: false, critical: false },
        testing: { unit: true, integration: false, visual: false }
      },
      production: {
        accessibility: { required: true, level: 'AA' as const, features: ['keyboard', 'screenReader', 'semantics'] },
        performance: { lazy: true, memoization: true, critical: true },
        testing: { unit: true, integration: true, visual: false }
      },
      enterprise: {
        accessibility: { required: true, level: 'AAA' as const, features: ['keyboard', 'screenReader', 'colorContrast', 'focus', 'semantics'] },
  ...
  protected getBaseStyling(): StylingApproach {
    return 'tailwind';
  }

  protected getBaseIntegrations() {
    return {
      apis: [],
      services: ['vercel'],
...
export class RestaurantTemplateGenerator extends BaseTemplateGenerator {
  generateComponents(): IComponentSpec[] {
    const qualitySpecs = this.getBaseQualitySpecs();
    ...
    return [
      ...
      },
      {
        ...
        responsive: true,
        accessibility: qualitySpecs.accessibility,
        performance: { ...qualitySpecs.performance, critical: true },
        seo: {
          structured: true,
          meta: true,
          headings: true,
      ...
      },
      {
        ...
        styling: this.getBaseStyling(),
        responsive: true,
        accessibility: { ...qualitySpecs.accessibility, focus: true },
        performance: qualitySpecs.performance,
        seo: {
          structured: false,
          meta: false,
        ...
        testing: { ...qualitySpecs.testing, integration: true },
        integration: { ...this.getBaseIntegrations(), apis: ['reservation-api'] },
        customization: {
          themes: true,
      ...
      },
      {
        ...
        responsive: true,
        accessibility: qualitySpecs.accessibility,
        performance: { ...qualitySpecs.performance, lazy: true },
        seo: {
          structured: false,
          meta: false,
          headings: true,
      ...
      },
      {
        ...
        testing: qualitySpecs.testing,
        integration: { ...this.getBaseIntegrations(), apis: ['contact-api'], external: ['google-maps'] },
        customization: {
          themes: true,
    ...
    return [
      {
        ...
        meta: {
          title: `${this.context.brand.name} - Restaurant Gastronomique`,
          description: `Découvrez ${this.context.brand.name}, restaurant gastronomique proposant une cuisine authentique et raffinée.`,
          ...
          jsonLd: [
            {
              ...
              description: `Restaurant gastronomique ${this.context.brand.name}`,
              url: '/',
      ...
      },
      {
        ...
        meta: {
          title: `Menu - ${this.context.brand.name}`,
          ...
          jsonLd: [
            {
              '@context': 'https://schema.org',
              '@type': 'Menu',
              name: `Menu ${this.context.brand.name}`,
      ...
      },
      {
        ...
        meta: {
          title: `Réservation - ${this.context.brand.name}`,
          description: `Réservez votre table au ${this.context.brand.name}. Réservation en ligne simple et rapide.`,
        ...
        accessibility: { ...this.getBaseQualitySpecs().accessibility, focus: true },
        seo: {
          structured: false,
          breadcrumbs: true,
          pagination: false,
      ...
      },
      {
        ...
        meta: {
          title: `À propos - ${this.context.brand.name}`,
          description: `Découvrez l'histoire et la philosophie du ${this.context.brand.name}, notre chef et notre équipe.`,
      ...
      },
      {
        ...
        meta: {
          title: `Contact - ${this.context.brand.name}`,
          description: `Contactez le ${this.context.brand.name}. Adresse, téléphone, horaires et formulaire de contact.`,
  ...
  getConfiguration(): Record<string, any> {
    return {
      ...
      'package.json': {
        name: `${this.context.projectName.toLowerCase().replace(/\s+/g, '-')}`,
        version: '1.0.0',
        private: true,
        scripts: {
          dev: 'next dev',
...
export class EcommerceTemplateGenerator extends BaseTemplateGenerator {
  generateComponents(): IComponentSpec[] {
    const qualitySpecs = this.getBaseQualitySpecs();
    ...
    return [
      {
        ...
        testing: qualitySpecs.testing,
        integration: { ...this.getBaseIntegrations(), apis: ['cart-api', 'auth-api'] },
        customization: {
          themes: true,
      ...
      },
      {
        ...
        testing: qualitySpecs.testing,
        integration: { ...this.getBaseIntegrations(), apis: ['cart-api', 'wishlist-api'] },
        customization: {
          themes: true,
      ...
      {
        name: 'ShoppingCart',
        type: 'interactive' as ComponentType,
        ...
        testing: { ...qualitySpecs.testing, integration: true },
        integration: { ...this.getBaseIntegrations(), apis: ['cart-api'] },
        customization: {
          themes: true,
      ...
      },
      {
        ...
        testing: { ...qualitySpecs.testing, integration: true },
        integration: { ...this.getBaseIntegrations(), apis: ['checkout-api', 'payment-api'], external: ['stripe'] },
        customization: {
          themes: true,
    ...
    return [
      {
        ...
        meta: {
          title: `${this.context.brand.name} - Boutique en ligne`,
          description: `Découvrez notre collection ${this.context.brand.name}. Livraison rapide et service client de qualité.`,
          ...
          jsonLd: [
            {
              ...
              '@type': 'OnlineStore',
              name: this.context.brand.name,
              description: `Boutique en ligne ${this.context.brand.name}`,
              url: '/'
            }
          ]
        },
...
export class SaasTemplateGenerator extends BaseTemplateGenerator {
  generateComponents(): IComponentSpec[] {
...
export class PortfolioTemplateGenerator extends BaseTemplateGenerator {
  generateComponents(): IComponentSpec[] {
...
export class TemplateGeneratorFactory {
  public static create(
    ...
    switch (projectType) {
      ...
      default:
        throw new Error(`Type de projet non supporté: ${projectType}`);
    }
  }

  public static getAvailableTemplates(): ProjectType[] {
    return ['restaurant', 'ecommerce', 'saas', 'portfolio'];
  }

  public static getTemplateInfo(projectType: ProjectType): IProjectTemplate {
    switch (projectType) {
      case 'restaurant':
        return {
...
export default TemplateGeneratorFactory;